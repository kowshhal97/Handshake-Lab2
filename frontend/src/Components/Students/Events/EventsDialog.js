    ...
    return (
      <div >
        ...
        >
          ...
          <DialogContent>
            <EventDetails eventId={this.props.eventId } eventName={this.state.event_name} eventDescription={this.state.event_description} time={this.state.event_timing} fromDate={this.state.event_from_date} toDate={this.state.event_to_date} location={this.state.event_location} eligibility={this.state.event_eligibility_criteria} major={this.state.event_major}  />
          </DialogContent>
          <DialogActions>
