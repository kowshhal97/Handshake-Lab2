...
class RecipeReviewCard extends React.Component {
    state = {
        img:"https://handshake-project.s3-us-west-2.amazonaws.com/profile_"+this.props.studentId+1,
        expanded: false,
        ...
        return (
            <Card className={classes.card}>
                <CardHeader
                    ...
                    title={this.props.BasicDetails.student_name}
                    subheader={this.props.BasicDetails.major}
                ...
                <CardContent>
                    ...
                    <Typography component="p">
                        {this.state.editBasicDetails ? (<TextField className={classes.textStyle} id="outlined-basic" label="Career Objective" variant="outlined" defaultValue={this.props.BasicDetails.career_objective} onChange={this.props.changeObj} />) :
                            (this.props.BasicDetails.career_objective)}
                    </Typography>
                </CardContent>
                ...
                <Collapse in={this.state.expanded} timeout="auto" unmountOnExit>
                    <CardContent>
                        ...
                        <List className={classes.root}>
                            {this.state.editBasicDetails ? (<TextField className={classes.textStyle} id="outlined-basic" label="College Name" variant="outlined" defaultValue={this.props.BasicDetails.student_college_name} disabled />) : (<ListItem alignItems="flex-start">
                                <ListItemAvatar>
                                    <Avatar alt="Remy Sharp" src="https://cdn2.iconfinder.com/data/icons/maki/100/college-512.png" />
                                </ListItemAvatar>
                                <ListItemText
                                    primary="College"
                                    secondary={
                                        <React.Fragment>
                                            ...
                                            >
                                                {this.props.BasicDetails.student_college_name}
                                            </Typography>
                                        </React.Fragment>
                                    }
                                />
                                ...
                                <ListItemText
                                    ...
                                    secondary={
                                        <React.Fragment>
                                            ...
                                            // color="textPrimary"
                                            >
                                                {this.props.extraDetails.city_name}
                                            </Typography>
                            ...
                            <Divider variant="inset" component="li" />
                            {this.state.editBasicDetails ? (<TextField className={classes.textStyle} id="outlined-basic" label="State Name" variant="outlined" defaultValue={this.props.extraDetails.state_name} onChange={this.props.changeSta} />) : (<ListItem alignItems="flex-start">
                                <ListItemAvatar>
                                    <Avatar alt="Travis Howard" src="https://static.thenounproject.com/png/15214-200.png" />
                                </ListItemAvatar>
                                <ListItemText
                                    primary="State"
                                    secondary={
                                        <React.Fragment>
                                            ...
                                            // color="textPrimary"
                                            >
                                                {this.props.extraDetails.state_name}
                                            </Typography>
                                        </React.Fragment>
                                    }
                                />
                            ...
                            <Divider variant="inset" component="li" />
                            {this.state.editBasicDetails ? (<TextField className={classes.textStyle} id="outlined-basic" label="Country Name" variant="outlined" defaultValue={this.props.extraDetails.country_name} onChange={this.props.changeCon} />) : (<ListItem alignItems="flex-start">
                                <ListItemAvatar>
                                    <Avatar alt="Cindy Baker" src="https://cdn3.iconfinder.com/data/icons/location-set/50/planet-512.png" />
                                </ListItemAvatar>
                                <ListItemText
                                    primary="Country"
                                    secondary={
                                        <React.Fragment>
                                            <Typography
                                                ...
                                                className={classes.inline}
                                            >
                                                {this.props.extraDetails.country_name}
                                            </Typography>
                                        </React.Fragment>
                                    }
                                />
                            ...
                            <Divider variant="inset" component="li" />
                            {this.state.editBasicDetails ? (<TextField className={classes.textStyle} id="outlined-basic" label="Phone Number" variant="outlined" defaultValue={this.props.extraDetails.phone_number} onChange={this.props.changePh} />) : (<ListItem alignItems="flex-start">
                                <ListItemAvatar>
                                    <Avatar alt="Travis Howard" src="https://cdn.onlinewebfonts.com/svg/img_352137.png" />
                                </ListItemAvatar>
                                <ListItemText
                                    ...
                                    secondary={
                                        <React.Fragment>
                                            ...
                                            // color="textPrimary"
                                            >
                                                {this.props.extraDetails.phone_number}
                                            </Typography>
                                        </React.Fragment>
                                    }
                                />
                            ...
                            <Divider variant="inset" component="li" />
                            {this.state.editBasicDetails ? (<TextField className={classes.textStyle} id="outlined-basic" label="Date Of Birth" variant="outlined" defaultValue={this.props.extraDetails.date_of_birth} onChange={this.props.changeDob} />) : (<ListItem alignItems="flex-start">
                                <ListItemAvatar>
                                    <Avatar alt="Travis Howard" src="https://image.flaticon.com/icons/png/512/2195/2195392.png" />
                                </ListItemAvatar>
                                <ListItemText
                                    ...
                                    secondary={
                                        <React.Fragment>
                                            ...
                                            // color="textPrimary"
                                            >
                                                {this.props.extraDetails.date_of_birth}
                                            </Typography>
                                        </React.Fragment>
                                    }
                                />
